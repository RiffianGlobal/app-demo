        ...
        <div class="flex grow justify-between p-4 bg-black/20">
          ...
          <div class="flex gap-6">
            ...
            <div>
              ...
              <div class="text-sm">
                ${g((e=this.social)==null?void 0:e.verified,()=>d`<span><i class="text-green-600 text-sm mdi mdi-check-decagram"></i></span>`)}${(t=this.social)==null?void 0:t.name}
              </div>
              ${g((s=this.social)==null?void 0:s.id,()=>{var i,r;return d`
                  <a class="text-sm text-blue-300" href="${(i=this.social)==null?void 0:i.url}" target="_blank">@${(r=this.social)==null?void 0:r.id}</a>
                `},()=>d`-`)}

              <div class="text-neutral-400">
                You own
                ${g(this.ts,()=>d`${x(this.myVotes,0)}`,()=>d`<i class="text-sm mdi mdi-loading"></i>`)}
                tickets
              </div>
            </div>
          </div>
        ...
        <div class="mt-8">
          ${g(!this.pending,()=>d`
              ${g(this.ts&&this.action==="vote",()=>d`
                ...
                `)}
              ${g(this.ts&&this.hasVoted&&this.action==="retreat",()=>d`
