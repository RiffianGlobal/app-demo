import{T as b,b as y,o as x}from"./index-HMsJOI_U.js";import{b as f,m as w,v as $,r as P,c as V,d as S,e as k}from"./action-0FkBxUt_.js";import{c as g,f as n,x as i,n as h,a3 as m,k as r,a as d,b as D}from"./vendor-LAl1UpEa.js";var T=Object.defineProperty,C=Object.getOwnPropertyDescriptor,e=(t,a,c,o)=>{for(var l=o>1?void 0:o?C(a,c):a,p=t.length-1,u;p>=0;p--)(u=t[p])&&(l=(o?u(a,c,l):u(l))||l);return o&&l&&T(a,c,l),l};const v=()=>({tx:""});let s=class extends b(""){constructor(){super(...arguments),this.bindBridge=new g(this,y),this.bindTweets=new g(this,x),this.action="",this.album="",this.url="",this.name="",this.author="",this.myVotes=0,this.retreatPrice=0,this.retreatDisabled=!0,this.tx=null,this.success=!1,this.pending=!1,this.rewards=!1,this.err=v(),this.ts=0,this.resetState=()=>{this.err=v(),this.pending=!1,this.success=!1,this.price=void 0,this.votes=void 0},this.emitChange=()=>this.emit("change"),this.close=async()=>{this.tx=null,this.resetState(),this.emit("close")},this.updateErr=(t={})=>this.err=Object.assign({},this.err,t)}async connectedCallback(){super.connectedCallback(),await this.getPrice(),await this.readFromTwitter(),this.ts++}get hasVoted(){return this.ts&&+n(this.myVotes,1)>0}async readFromTwitter(){this.social=await x.fromAddress(this.author)}async getPrice(){try{this.votes=f(this.album).then(t=>t[4]),this.myVotes=await w(this.album).then(t=>(t>0&&(this.retreatDisabled=!1),t)),this.price=$(this.album).then(t=>n(t)),this.retreatPrice=await P(this.album).then(t=>n(t))}catch(t){let a=t.message||t.code;this.updateErr({tx:a})}}async vote(){this.pending=!0;try{this.tx=await S(this.album,1,{value:(await V(this.album))[0]}),this.success=await this.tx.wait(),await this.emitChange()}catch(t){let a=t.message||t.code;if(t.code===4001)return this.updateErr({tx:a}),this.close();this.tx||(this.tx={},this.tx.status=0,this.tx.err=t)}}async retreat(){this.pending=!0;try{this.tx=await k(this.album,1),this.success=await this.tx.wait(),await this.emitChange()}catch(t){let a=t.message||t.code;if(t.code===4001)return this.updateErr({tx:a}),this.close();this.tx||(this.tx={},this.tx.status=0,this.tx.err=t)}}render(){var t,a,c;return i`<ui-dialog
      @close=${()=>{this.close()}}
    >
    ...
    </ui-dialog>`}};e([d({type:String})],s.prototype,"action",2);e([d({type:String})],s.prototype,"album",2);e([d({type:String})],s.prototype,"url",2);e([d({type:String})],s.prototype,"name",2);e([d({type:String})],s.prototype,"author",2);e([d({type:Promise})],s.prototype,"votes",2);e([r()],s.prototype,"myVotes",2);e([r()],s.prototype,"price",2);e([r()],s.prototype,"retreatPrice",2);e([r()],s.prototype,"retreatDisabled",2);e([r()],s.prototype,"social",2);e([r()],s.prototype,"tx",2);e([r()],s.prototype,"success",2);e([r()],s.prototype,"pending",2);e([r()],s.prototype,"rewards",2);e([r()],s.prototype,"err",2);e([r()],s.prototype,"ts",2);s=e([D("vote-album-dialog")],s);
