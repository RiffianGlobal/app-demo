import{g as $,T as x,b as v}from"./index-S80eJr7Y.js";import{c as g,e as k,a0 as C,x as l,d as O,n as m,q as b,h as d,a as u,b as y,K as P}from"./vendor-_vG9yl0N.js";import{t as w}from"./dialog-V6UCpsLR.js";import"./icon-HrLy0Q8r.js";const M=async e=>{let t=`{
      user(id: "`+e+`") {
        address
        holding
        id
    ...
    }`;return await $("MediaBoard",t)},D=async e=>{let t=`{
      user(id: "`+e+`") {
        address
        holding
        id
    ...
    }`;return await $("MediaBoard",t)},T="li.header{margin-bottom:.75rem;font-size:.875rem;line-height:1.25rem;--tw-text-opacity: 1;color:#a3a3a3;color:rgba(163,163,163,var(--tw-text-opacity))}li.item:hover{background-color:#ffffff0d}@media (min-width: 500px){.name{font-size:1rem;line-height:1.5rem}}.icon{font-size:1.5rem;line-height:2rem}@media (max-width: 500px){.icon{font-size:1.5rem;line-height:2rem}}";var j=Object.defineProperty,L=Object.getOwnPropertyDescriptor,h=(e,t,i,r)=>{for(var s=r>1?void 0:r?L(t,i):t,n=e.length-1,p;n>=0;n--)(p=e[n])&&(s=(r?p(t,i,s):p(s))||s);return r&&s&&j(t,i,s),s};let c=class extends x(T){constructor(){super(...arguments),this.bindBridge=new g(this,v),this.weekly=!1,this.address="",this.userData={},this.trackList=[],this.pending=!1,this.prompt=!1,this.promptMessage="",this.init=async()=>{var e;this.pending=!0;try{let t=await M(this.address);this.trackList=(e=t.user)==null?void 0:e.subjectsCreated,this.userData=t.user}catch(t){console.error(t),this.promptMessage=t,this.prompt=!0;return}finally{this.pending=!1}},this.close=()=>{this.init()},this.go2=e=>{this.disabled?k.emit("connect-wallet"):C(`/track/${e.address}`)}}get disabled(){return!v.bridge.account}connectedCallback(){super.connectedCallback(),this.init()}getRandomInt(e){return Math.floor(Math.random()*e)}render(){return l`<div role="list" class="ui-list py-6 ${O(this.$c([this.pending?"loading":"hover"]))}">
